...
class ChipEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit ChipEditor (ChipProcessor&);
    ~ChipEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ChipEditor)
};
