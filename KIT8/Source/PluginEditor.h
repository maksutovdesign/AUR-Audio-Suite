...
class Kit8Editor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit Kit8Editor (Kit8Processor&);
    ~Kit8Editor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Kit8Editor)
};
