...
Kit8Editor::Kit8Editor (Kit8Processor& p)
      ...
      keyboard (p.getKeyboardState(), juce::MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    cells = {
        { ParamID::sweep, "SWEEP", false }, { ParamID::punch, "PUNCH", false }, { ParamID::decay, "DECAY", false },
        { ParamID::tone, "TONE", false }, { ParamID::glide, "GLIDE", false },
...
Kit8Editor::~Kit8Editor() { stopTimer(); setLookAndFeel (nullptr); }

void Kit8Editor::refreshPresetBox()
{
...
void Kit8Editor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "KIT8", "Melodic 808 kick/bass");
}

void Kit8Editor::resized()
{
