...
SubEditor::SubEditor (SubProcessor& p)
      ...
      keyboard (p.getKeyboardState(), juce::MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    cells = {
        { ParamID::punch, "PUNCH", false }, { ParamID::harm, "HARM", false },
...
SubEditor::~SubEditor() { stopTimer(); setLookAndFeel (nullptr); }

void SubEditor::refreshPresetBox()
{
...
void SubEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "SUB", "Pure sub bass");
}

void SubEditor::resized()
{
