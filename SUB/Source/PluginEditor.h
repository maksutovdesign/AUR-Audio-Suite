...
class SubEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit SubEditor (SubProcessor&);
    ~SubEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SubEditor)
};
