...
class OrganEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit OrganEditor (OrganProcessor&);
    ~OrganEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OrganEditor)
};
