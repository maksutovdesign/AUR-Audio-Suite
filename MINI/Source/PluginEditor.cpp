...
MiniEditor::MiniEditor (MiniProcessor& p)
      ...
      keyboard (p.getKeyboardState(), juce::MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    cells = {
        { ParamID::shape, "SHAPE", true }, { ParamID::pw, "PW", false }, { ParamID::sub, "SUB", false },
        { ParamID::cutoff, "CUTOFF", false }, { ParamID::reso, "RESO", false }, { ParamID::envamt, "ENV", false }, { ParamID::keytrack, "KEYTRK", false },
...
MiniEditor::~MiniEditor() { stopTimer(); setLookAndFeel (nullptr); }

void MiniEditor::refreshPresetBox()
{
...
void MiniEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "MINI", "Compact subtractive synth");
}
