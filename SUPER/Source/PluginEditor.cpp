...
SuperEditor::SuperEditor (SuperProcessor& p)
      ...
      keyboard (p.getKeyboardState(), juce::MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    cells = {
        { ParamID::detune, "DETUNE", false }, { ParamID::spread, "SPREAD", false }, { ParamID::mixOsc, "MIX", false },
...
void SuperEditor::refreshPresetBox()
{
...
void SuperEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "SUPER", "Supersaw stack (7 saws)");
}

void SuperEditor::resized()
{
