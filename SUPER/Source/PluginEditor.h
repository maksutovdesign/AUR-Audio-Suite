...
class SuperEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit SuperEditor (SuperProcessor&);
    ~SuperEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SuperEditor)
};
