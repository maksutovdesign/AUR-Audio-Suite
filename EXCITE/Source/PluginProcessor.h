...
#include "Exciter.h"
#include "Metering.h"
class ExciteProcessor : public juce::AudioProcessor{
public:
  ExciteProcessor();
  ~ExciteProcessor() override=default;
...
private:
  juce::AudioProcessorValueTreeState apvts; aur::MeterState meters; aur::Exciter fx; int cur=0;
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ExciteProcessor)
};
