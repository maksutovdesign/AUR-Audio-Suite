...
class StringEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit StringEditor (StringProcessor&);
    ~StringEditor() override;
...
private:
    ...
    StringProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StringEditor)
};
