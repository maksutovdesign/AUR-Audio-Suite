...
StringEditor::StringEditor (StringProcessor& p)
      ...
      keyboard (p.getKeyboardState(), juce::MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    cells = {
        { ParamID::octave, "OCTAVE", false }, { ParamID::ensemble, "ENSEMBLE", false }, { ParamID::rate, "RATE", false }, { ParamID::tone, "TONE", false },
...
StringEditor::~StringEditor() { stopTimer(); setLookAndFeel (nullptr); }

void StringEditor::refreshPresetBox()
{
...
void StringEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "STRING", "String ensemble (Solina-style)");
}

void StringEditor::resized()
{
