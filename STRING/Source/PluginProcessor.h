...
class StringProcessor : public juce::AudioProcessor
{
public:
    StringProcessor();
    ~StringProcessor() override = default;
...
private:
    ...
    aur::ModChorus chorus;
    std::atomic<float>* pEns = nullptr; std::atomic<float>* pRate = nullptr;
