...
/** AUR NOVA — 4-operator FM synthesizer. */
class NovaProcessor : public juce::AudioProcessor
{
public:
    NovaProcessor();
    ~NovaProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NovaProcessor)
};
