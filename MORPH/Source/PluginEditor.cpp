      ...
      keyboard (p.getKeyboardState(), juce::MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    cells = {
        { ParamID::morph, "MORPH", false }, { ParamID::motion, "MOTION", false }, { ParamID::rate, "RATE", false },
...
void MorphEditor::refreshPresetBox()
{
...
void MorphEditor::paint (juce::Graphics& g)
{
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "MORPH", "Engine morpher (VA-FM-WT-Additive)");
}
