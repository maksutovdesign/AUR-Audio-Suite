...
namespace ParamID
{
    static constexpr auto morph   = "morph";   // 0..1 across 4 engines
    static constexpr auto motion  = "motion";  // LFO→morph
...
namespace Params
{
    inline juce::AudioProcessorValueTreeState::ParameterLayout createLayout()
    {
        ...
        f (ParamID::morph, "Morph (VA-FM-WT-ADD)", 0.f, 1.f, 0.2f, 1.f, pct);
        f (ParamID::motion, "Motion", 0.f, 1.f, 0.3f, 1.f, pct);
        f (ParamID::rate, "Rate", 0.02f, 8.f, 0.3f, 0.35f, [](float v,int){return String(v,2)+" Hz";});
        ...
        f (ParamID::attack, "Attack", 0.001f, 5.f, 0.03f, 0.3f, sec);
