...
namespace ParamID
{
    ...
    static constexpr auto motion  = "motion";   // slow LFO depth on detune+cutoff
...
namespace Params
{
    inline juce::AudioProcessorValueTreeState::ParameterLayout createLayout()
    {
        ...
        f (ParamID::cutoff, "Cutoff", 20.f, 20000.f, 2500.f, 0.28f, [](float v,int){return v<1000.f?String((int)v)+" Hz":String(v/1000.f,2)+" kHz";});
        f (ParamID::reso, "Resonance", 0.f, 1.f, 0.2f, 1.f, pct);
        f (ParamID::attack, "Attack", 0.05f, 10.f, 1.5f, 0.3f, sec);
        f (ParamID::release, "Release", 0.05f, 15.f, 3.f, 0.3f, sec);
