...
class DroneEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit DroneEditor (DroneProcessor&);
    ~DroneEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DroneEditor)
};
