...
DroneEditor::DroneEditor (DroneProcessor& p)
...
DroneEditor::~DroneEditor() { stopTimer(); setLookAndFeel (nullptr); }

void DroneEditor::refreshPresetBox()
{
...
void DroneEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "DRONE", "Evolving drone generator");
}

void DroneEditor::resized()
{
