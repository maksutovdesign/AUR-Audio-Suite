...
#include "Metering.h"
class CrushProcessor : public juce::AudioProcessor{
public:
  CrushProcessor();
  ~CrushProcessor() override=default;
...
private:
  juce::AudioProcessorValueTreeState apvts; aur::MeterState meters; aur::BitCrusher fx; int cur=0;
