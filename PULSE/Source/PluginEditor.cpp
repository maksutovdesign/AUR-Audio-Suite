...
PulseEditor::~PulseEditor() { stopTimer(); setLookAndFeel (nullptr); }

void PulseEditor::refreshPresetBox()
{
...
void PulseEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 420, 60 }, "PULSE", "Analog drum machine");
}
