...
/** AUR DEESS — split-band de-esser. */
class DeessProcessor : public juce::AudioProcessor
{
public:
    DeessProcessor();
    ~DeessProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DeessProcessor)
};
