...
def editor_cpp(cfg):
    ...
    T = ('#include "PluginEditor.h"\n#include "Parameters.h"\n#include "Presets.h"\n#include "Theme.h"\n#include "Branding.h"\nusing namespace aur::ui;\n'
        ...
        'void @PEditor::applyThemeChoice(int i){ switch(i){case 1: aur::ui::setTheme(aur::ui::obsidianTheme());break; case 2: aur::ui::setTheme(aur::ui::fluxTheme());break; default: aur::ui::setTheme(aur::ui::moltenTheme());} lnf.applyTheme(); sendLookAndFeelChange(); repaint(); }\n'
