...
BellEditor::BellEditor (BellProcessor& p)
...
BellEditor::~BellEditor() { stopTimer(); setLookAndFeel (nullptr); }

void BellEditor::refreshPresetBox()
{
...
void BellEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "BELL", "Modal bells & mallets");
}

void BellEditor::resized()
{
