...
class BellEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit BellEditor (BellProcessor&);
    ~BellEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BellEditor)
};
