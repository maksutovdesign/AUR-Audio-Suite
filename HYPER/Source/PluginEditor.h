...
class HyperEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit HyperEditor (HyperProcessor&);
    ~HyperEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (HyperEditor)
};
