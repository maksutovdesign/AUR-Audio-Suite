...
PadEditor::PadEditor (PadProcessor& p)
...
PadEditor::~PadEditor() { stopTimer(); setLookAndFeel (nullptr); }

void PadEditor::refreshPresetBox()
{
...
void PadEditor::paint (juce::Graphics& g)
{
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "PAD", "Additive evolving pad");
}
