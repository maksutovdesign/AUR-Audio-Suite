...
/** AUR KIT9 — analog drum machine (synthesised, no samples). */
class Kit9Processor : public juce::AudioProcessor
{
public:
    Kit9Processor();
    ~Kit9Processor() override = default;
...
private:
    ...
    aur::syn::Kick9Voice  kick;
    aur::syn::Snare9Voice snare;
    aur::syn::ClapVoice  clap;
    aur::syn::Hat9Voice   chat, ohat;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Kit9Processor)
};
