...
ResEditor::ResEditor (ResProcessor& p)
      ...
      keyboard (p.getKeyboardState(), juce::MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    cells = {
        { ParamID::exciter, "EXCITER", false }, { ParamID::pick, "PICK", false }, { ParamID::resfb, "RESO", false },
        { ParamID::damp, "DAMP", false }, { ParamID::body, "BODY", false },
...
ResEditor::~ResEditor() { stopTimer(); setLookAndFeel (nullptr); }

void ResEditor::refreshPresetBox()
{
...
void ResEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 380, 60 }, "RES", "Comb resonator (bowed/blown/plucked)");
}

void ResEditor::resized()
{
