...
#include "Metering.h"
class TransientProcessor : public juce::AudioProcessor{
public:
  TransientProcessor();
  ~TransientProcessor() override=default;
...
private:
  juce::AudioProcessorValueTreeState apvts; aur::MeterState meters; aur::TransientShaper fx; int cur=0;
