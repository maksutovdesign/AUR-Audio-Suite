...
#include "Clipper.h"
#include "Metering.h"
class ClipperProcessor : public juce::AudioProcessor{
public:
  ClipperProcessor();
  ~ClipperProcessor() override=default;
...
private:
  juce::AudioProcessorValueTreeState apvts; aur::MeterState meters; aur::Clipper fx; int cur=0;
