...
namespace ParamID
{
    static constexpr auto morph   = "morph";     // wavetable position
    static constexpr auto lfoamt  = "lfoamt";    // LFO→morph
    static constexpr auto lforate = "lforate";
    static constexpr auto detune  = "detune";    // 2nd osc detune
...
namespace Params
{
    inline juce::AudioProcessorValueTreeState::ParameterLayout createLayout()
    {
        ...
        f (ParamID::morph, "Morph", 0.f, 1.f, 0.6f, 1.f, pct);
        f (ParamID::lfoamt, "LFO Amt", 0.f, 1.f, 0.2f, 1.f, pct);
        f (ParamID::lforate, "LFO Rate", 0.02f, 12.f, 0.7f, 0.35f, [](float v,int){return String(v,2)+" Hz";});
        f (ParamID::detune, "Detune", 0.f, 1.f, 0.3f, 1.f, pct);
        f (ParamID::cutoff, "Cutoff", 20.f, 20000.f, 10000.f, 0.28f, [](float v,int){return v<1000.f?String((int)v)+" Hz":String(v/1000.f,2)+" kHz";});
        f (ParamID::reso, "Resonance", 0.f, 1.f, 0.15f, 1.f, pct);
        f (ParamID::envamt, "Env Amount", 0.f, 1.f, 0.3f, 1.f, pct);
        f (ParamID::attack, "Attack", 0.001f, 5.f, 0.01f, 0.3f, sec);
        f (ParamID::decay, "Decay", 0.001f, 5.f, 0.4f, 0.3f, sec);
        f (ParamID::sustain, "Sustain", 0.f, 1.f, 0.75f, 1.f, pct);
        f (ParamID::release, "Release", 0.001f, 8.f, 0.35f, 0.3f, sec);
