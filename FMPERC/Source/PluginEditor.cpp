...
FmpercEditor::FmpercEditor (FmpercProcessor& p)
...
FmpercEditor::~FmpercEditor() { stopTimer(); setLookAndFeel (nullptr); }

void FmpercEditor::refreshPresetBox()
{
...
void FmpercEditor::paint (juce::Graphics& g)
{
    const auto& t = theme();
    g.fillAll (t.ground);
    ...
    drawBrandHeader (g, { 20, 16, 420, 60 }, "FMPERC", "FM percussion kit");
}

void FmpercEditor::resized()
{
