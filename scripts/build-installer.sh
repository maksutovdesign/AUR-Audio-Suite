...
VERSION="0.1.0"
MODULES=(EMBER CLARITY GRIP CEIL PRISM HAZE SCOPE IMAGER DELAY MOTION ASSIST FORGE DEESS DEHUM GATE DENOISE CHORUS FLANGER PHASER TREMOLO CLIPPER CRUSH TRANSIENT MULTI EXCITE GAIN GONIO TUNER PITCH CONVO RING)
